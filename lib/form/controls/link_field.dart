...
import 'package:flutter_form_builder/flutter_form_builder.dart' as d;
...
class _LinkFieldState extends State<LinkField> implements Control, ControlInput {
  @override
  Widget build(BuildContext context) {
    ...
    return Theme(
      data: Theme.of(context).copyWith(primaryColor: Colors.black), child: Text("from"),
      // child: d.FormBuilderTypeAhead(
      //   key: widget.key,
      //   enabled: enabled,
