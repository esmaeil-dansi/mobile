  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        //   backgroundColor: Color(0xFF12E312),
        //   bottom: const TabBar(
        //     tabs: [
        //       Tab(
        //         text: "صفحه 1",
                                ...
                                child: InputDecorator(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      TextField(
                                        controller: TextEditingController(text: vetVisitInfoModel.nameDamp),
                                        decoration: InputDecoration(
                                      ...
                                      SizedBox(
                                        height: 50,
                                        child: TextField(
                                          controller: TextEditingController(text: vetVisitInfoModel.codeN),
                                          decoration: InputDecoration(
                                      ...
                                      SizedBox(
                                        height: 50,
                                        child: TextField(
                                          controller: TextEditingController(text: vetVisitInfoModel.nationalIdDoc),
                                          onChanged: (_) {
                                            // national_id_doc = _;
                                          },
